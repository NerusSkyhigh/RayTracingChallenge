...
public:
    ...
    Sphere(): origin(Tuple::point(0,0,0)), transform(Matrix::identity(4)) {}

    Sphere(const double r, const Tuple origin) : origin(origin), transform(Matrix::identity(4)) {}

    Sphere(Material material) : origin(Tuple::point(0, 0, 0)), material(material), transform(Matrix::identity(4)) {}
